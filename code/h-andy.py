...
For the control of the hand, only B, C and E will be used
...
CURRENT_INCREMENT = 10 # mA
POSITION_INCREMENT = 256 # 4096 is a full revolution
...
def on_release(key):
    ...
    try:
        ...
        # for more info regarding control modes, please consult dynamixel_port-API-documentation in this folder
            ...
            dxl.set_operating_mode(motor_ids_to_control, 5)
            control_mode = 5
        ...
        # position, velocity etc    
            ...
            pos_now = dxl.get_pos(motor_ids_to_control)
